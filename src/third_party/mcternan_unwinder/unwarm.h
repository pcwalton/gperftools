...
#ifndef UPGRADE_ARM_STACK_UNWIND
...
typedef int RegValOrigin;
    /** Invalid value. */
#define     REG_VAL_INVALID      0x00
#define     REG_VAL_FROM_STACK   0x01
#define     REG_VAL_FROM_MEMORY  0x02
#define     REG_VAL_FROM_CONST   0x04
#define     REG_VAL_ARITHMETIC   0x80
